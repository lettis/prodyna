...
prodyna::clustering.microstates(rc          = rc, 
                                radius      = radius,
                                prefix_fe   = "clustering/freeEnergy",
                                nn          = "clustering/neighbours", 
                                init        = "clustering/network_end_node_traj.dat", 
                                microstates = "clustering/microstates",
                                sorted      = T) 
```

```{r}
T <- msm.transitionMatrix(traj=paste("microstates", sep="/"),
                          lag=1)
